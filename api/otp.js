...
async function sendEmail(to, code) {
  ...
  const subject = `رمز التحقق: ${code} — Business Partner`;
  // ‏رمز الدخول أَولى ما يخرج من أزور: رسالةٌ لا تصل هنا تعني عميلاً محبوساً
  // خارج حسابه. أزور أولاً، وResend بديلٌ حتى يكتمل النقل.
