...
عشرة مشاريع، لكل واحد مالك ونطاق ملفات **لا يتقاطع مع غيره**. الوكلاء معرَّفون
...
| `broker-referral` | السماسرة والإحالة والعمولات (لم يُبنَ بعد) |
...
وكيلٌ جديد لا يُنشأ إلا لنطاق ملفات لا يملكه أحد من العشرة، ويُضاف إلى الجدول
