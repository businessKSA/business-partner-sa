...
| 4 | **محمد Mohammed** | TEAM-004: Legal & Compliance Review Agent | IT Manager (tech, website, APIs, subscriptions) | ✅ Resolved 2 Jul: **IT Manager** — legal scope merged into عبدالعزيز (see §8) |
| 5 | **فرح Farah** | TEAM-005: Operations Manager & Escalation Owner | Marketing Manager (content, channels, broadcasts) | ✅ Resolved 2 Jul: **Marketing only, specialised** — ops/escalation moved to مازن (see §8) |
...
## 8. Conflicts — RESOLVED 2 Jul 2026 (Baher's direction)

Baher's rule: **choose other names where roles collide, merge roles with identical tasks,
and Marketing must be a specialised standalone function with nothing else attached.**

Applied map (new names taken from Baher's own 29 Jun pending-roles list — final naming
pending Baher's confirmation):

| Function | Agent |
|----------|-------|
| التسويق — specialised, nothing else | **فرح Farah** |
| تقنية المعلومات | **محمد Mohammed** |
| القانوني والامتثال (old TEAM-004 scope, same tasks → merged) | **عبدالعزيز** — مدير الشؤون القانونية |
| العمليات والتصعيد (old TEAM-005 scope, same tasks → merged) | **مازن** — مدير العمليات (also TEAM-001 WhatsApp CS) |

Follow-ups: rewrite TEAM-004/TEAM-005 in Notion and re-point the WhatsApp router's legal &
escalation handoffs once the name map is confirmed. Full record: `docs/conflicts-log.md`.
