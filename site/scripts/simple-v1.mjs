...
/* اتجاه «مختبر» (قرار المالك 2026-09-05): أرضية بيضاء، حبرٌ شبه أسود، لونُ
   إشارةٍ واحد #4338F5، شبكة ١px، حروفٌ أحادية للبيانات الوصفية وحدها — لا
   للعربية، فالأحادي اللاتيني يُسقط العربية إلى بديلٍ ممطوط.
   --n صار لونَ الإشارة (الأزرار والحالات النشطة)، و--ink حبرَ العناوين. */
.sv1{--n:#4338F5;--ac:#4338F5;--ac2:#6E63FF;--acSoft:#EFEEFE;--acLine:#CFCBFB;
 --n2:#0D1017;--g:#F5F7FA;--l:#E3E7EF;--line:#E3E7EF;--line2:#EDF0F6;
 --t:#0D1017;--ink:#0D1017;--s:#646C7E;--mut:#646C7E;--faint:#98A0B0;--soft:#F5F7FA;
 --ok:#0E9F6E;--okSoft:#E6F6F0;--warn:#B45309;--wa:#25D366;
 --sh:0 1px 2px rgba(13,16,23,.05);--sh2:0 22px 56px -18px rgba(13,16,23,.20),0 2px 8px rgba(13,16,23,.05);
 ...
 color:var(--ink);line-height:1.7;background:#fff;display:flex;flex-direction:column;min-height:100vh;
 -webkit-font-smoothing:antialiased}
.sv1 .m,.sv1 .en{font-family:var(--fm);font-variant-numeric:tabular-nums;font-feature-settings:"tnum"}
...
.sv1-bar{background:var(--n2);color:#B9BECC;font-size:11.5px}
...
.sv1-bar b{color:#F2F3F7;font-weight:400}
.sv1-pulse{width:5px;height:5px;border-radius:50%;background:var(--ok);display:inline-block;
 margin-inline-end:7px;box-shadow:0 0 0 0 rgba(14,159,110,.6);animation:sv1pulse 2.6s infinite}
@keyframes sv1pulse{70%{box-shadow:0 0 0 7px rgba(14,159,110,0)}100%{box-shadow:0 0 0 0 rgba(14,159,110,0)}}
...
.sv1-bar-langs a.on{opacity:1;color:#F2F3F7}
...
.sv1-btn.primary{background:var(--ac);border-color:var(--ac);color:#fff;box-shadow:0 6px 18px -6px rgba(67,56,245,.5)}
.sv1-btn.primary:hover{background:#3A2FE8;border-color:#3A2FE8;transform:translateY(-1px)}
...
.sv1-hero::after{content:"";position:absolute;inset-inline-end:-6%;top:-46%;width:760px;height:760px;pointer-events:none;
 background:radial-gradient(circle,rgba(110,99,255,.15) 0%,rgba(110,99,255,.045) 38%,transparent 66%)}
