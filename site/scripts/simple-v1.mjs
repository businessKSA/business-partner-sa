...
const D = {
  ...
  chipsGovernment: { ar: ["مشكلة في قوى", "تصاريح أجير", "تغيير مهنة", "نقل خدمات", "تأشيرات", "النطاقات والتوطين", "إدارة المنصات"], en: ["A problem on Qiwa", "Ajeer permits", "Change a profession", "Transfer of services", "Visas", "Nitaqat & Saudisation", "Manage my platforms"], fr: ["Un problème sur Qiwa", "Permis Ajeer", "Changer une profession", "Transfert de services", "Visas", "Nitaqat et saoudisation", "Gérer mes plateformes"], zh: ["Qiwa 平台问题", "Ajeer 许可", "变更职业", "服务转移", "签证", "Nitaqat 与本地化", "代管平台"] },
