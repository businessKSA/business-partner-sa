...
// الحارس الذي يشتغل قبل أن يغادر الملف الجهاز. الخادم اليوم لا يرفض صيغة ولا
// حجماً (يُبدّل النوع المجهول بـ pdf ويقصّ ما زاد) — فالرسالة الواضحة هنا هي
// الفرق بين «ارفع غيره» وبين ملفٍ مبتور محفوظ بصمت.
