...
for(const file of walk(ROOT)){
  ...
  const header=`<header class="site-header bp-simple-header"><div class="bp-hdr"><a class="bp-logo" href="${prefix||''}/"><img src="/assets/img/logo.png" alt="Business Partner"></a><nav class="bp-nav"><a href="${href(prefix,'/#bp-consultant')}">${l.b10x}</a><details class="bp-dd"><summary>${l.services}</summary><div class="bp-mega">${mega}</div></details><a href="${href(prefix,'/packages')}">${l.packages}</a><details class="bp-dd"><summary>${l.advisors}</summary>${advisors}</details><a href="${href(prefix,'/about')}">${l.about}</a><a href="${href(prefix,'/contact')}">${l.contact}</a></nav><div class="bp-actions"><details class="bp-dd bp-lang"><summary>${l.lang}</summary>${langMenu}</details><a class="bp-cart cart-link" href="${href(prefix,'/cart')}" aria-label="${l.cart}"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"/></svg><span class="cart-badge" id="cart-badge" hidden>0</span></a><a class="bp-login" data-account-link href="${href(prefix,'/account')}"><span data-account-label>${l.login}</span></a><a class="bp-start" href="${href(prefix,'/consultation')}">${l.start}</a></div></div></header>`;
