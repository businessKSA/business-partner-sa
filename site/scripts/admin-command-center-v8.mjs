...
:root{--navy:#0B1B5A!important;--navy-700:#112c71!important;--navy-900:#05102f!important;--bg:#f6f8fc!important;--surface:#fff!important;--line:#e5eaf3!important;--text:#14203e!important;--soft:#68758f!important;--muted:#94a0b5!important;--radius:18px!important;--shadow:0 10px 32px rgba(18,38,85,.055)!important}
...
.side{width:228px!important;min-height:100dvh;padding:18px 12px!important;background:linear-gradient(180deg,#0B1B5A 0%,#0a245e 100%)!important;border-inline-end:1px solid rgba(255,255,255,.08)}
...
.nav button{padding:9px 10px!important;font-size:12.5px!important;border-radius:9px!important}.nav button.active{background:#fff!important;color:#0B1B5A!important;box-shadow:0 8px 20px rgba(0,0,0,.13)}
...
.bp-admin-command{background:linear-gradient(135deg,#0B1B5A 0%,#123f99 70%,#3159d8 100%);color:#fff;border-radius:22px;padding:20px 22px;display:grid;grid-template-columns:1.25fr .75fr;gap:18px;align-items:center;box-shadow:0 20px 50px rgba(15,47,125,.16);position:relative;overflow:hidden}
...
#aiFab{background:linear-gradient(135deg,#0B1B5A,#3159d8)!important;box-shadow:0 12px 30px rgba(36,75,184,.25)!important}
