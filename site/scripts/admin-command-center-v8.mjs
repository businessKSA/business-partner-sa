...
#app.on{align-items:flex-start}
.side{width:228px!important;padding:18px 12px!important;background:linear-gradient(180deg,#07163f 0%,#0a245e 100%)!important;border-inline-end:1px solid rgba(255,255,255,.08)}
