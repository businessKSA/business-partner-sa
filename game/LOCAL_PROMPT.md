...
```
أنت تعمل على جهازي المحلي لتحويل لعبة «الرايات الثلاث» من نموذج متصفح إلى مشروع Unreal Engine 5 كامل. نفّذ كل ما يلي بالترتيب، وتوقف واسألني فقط عند خطوة تحتاج تسجيل دخول أو تنزيلاً كبيراً أو قراراً مني. لا تسألني أسئلة يمكنك الإجابة عنها بفحص الجهاز أو الملفات.
